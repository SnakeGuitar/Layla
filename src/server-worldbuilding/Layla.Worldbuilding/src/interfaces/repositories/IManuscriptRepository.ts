...
export interface IManuscriptRepository {
   ...
   */
  getManuscript(projectId: string, manuscriptId: string): Promise<IManuscript | null>;
   ...
   */
  updateManuscript(projectId: string, manuscriptId: string, data: Partial<IManuscript>): Promise<IManuscript | null>;
   ...
   */
  getChapter(projectId: string, manuscriptId: string, chapterId: string): Promise<IChapter | null>;
   ...
   */
  createChapter(projectId: string, manuscriptId: string, chapter: Partial<IChapter>): Promise<IChapter | null>;
   ...
   */
  updateChapter(projectId: string, manuscriptId: string, chapterId: string, data: any): Promise<IManuscript | null>;
   ...
   */
  deleteChapter(projectId: string, manuscriptId: string, chapterId: string): Promise<boolean>;
}
